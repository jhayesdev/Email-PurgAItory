...
Email PurgAItory is a Python tool that uses AI to automate responses to annoying sales drones, streamlining email management tasks. It can use either a local AI model or the OpenAI API based on your configuration.
